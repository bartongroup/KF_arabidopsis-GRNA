...
CompBio::SpecFun::Gamma - gamma, log(gamma), incomplete gamma etc.

=head1 SYNOPSIS

    use CompBio::SpecFun::Gamma qw(gamma gammaln gammainc gammaincc);

Imports all the routines explicitly.  Use a subset of the list for the
routines you want.

    use CompBio::SpecFun::Gamma qw(:all);
...
function
    ...
    use CompBio::SpecFun::Gamma qw(gamma);
...
C<gammaln>
    ...
    use CompBio::SpecFun::Gamma qw(gammaln);
